...
HYPER_UNSAFE, = get_options(("hyper-unsafe", bool, False))
...
def main():
	...
	cwd_sanity_check("codegen/vertexbuffer_gen.py")
	...
	target_dir = Path.cwd() / "pyday_night_funkin/core/graphics"
	with (target_dir / "vertexbuffer.pxi").open("w", encoding="utf-8") as f:
